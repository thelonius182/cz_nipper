# vereiste naampatroon van een testscript: "test.*"
# vereist: een "context", die kort beschrijft wat de functie doet
# de eigenlijke unit-tests bestaan uit "expectations" in "test_that"-functies  
